...
dataL850_tau120_paper_log =
    save_data_to_dict(outputs, saving_dict, results850_tau120_paper_log, kp_list)
...
results_paper_time_pos_entry_L100_log = pmap(
    kp -> gather_first_pause_distribution(
        100,
        l_ribosome,
        track_site,
        init,
...
Plots.scatter(
    ...
    ylims = (0, 1),
    xlabel = "log10(kp)",
    ylabel = "Average position of first pause (s)",
    title = "Average position of first pause vs kp",
    legend = false,
)
